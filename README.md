...
- بارگذاری تنبل: فایل صوتی فقط وقتی پلیر به ویوپورت نزدیک می‌شود دانلود می‌شود؛ مدت زمان از هدر فایل خوانده می‌شود
- peaks سمت سرور با ffmpeg (اختیاری): موج فوری رسم می‌شود و فایل فقط هنگام پخش دانلود می‌شود؛ بدون ffmpeg به روش عادی کار می‌کند
